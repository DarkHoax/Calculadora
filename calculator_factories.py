...
def make_label(root) -> tk.Label:
    label = tk.Label(root, text="Sem conta ainda", anchor="e", justify="right", background="#fff")
...
def make_buttons(root) -> List[List[tk.Button]]:
    ...
    for row, row_value in enumerate(button_texts, start=2):
        ...
        for col_index, col_value in enumerate(row_value):
            ...
            btn.config(font=("Helvetica", 15,"normal"), pady=40, width=1, background="#f1f2f3", bd=0, cursor="hand2", highlightthickness=0, highlightcolor="#ccc",
